...
// Dashboard hooks.
add_action( 'activity_box_end', 'wp_dashboard_quota', 10, 0 );
...
// Admin color schemes.
add_action( 'admin_init', 'register_admin_color_schemes', 1, 0 );
add_action( 'admin_head', 'wp_color_scheme_settings', 10, 0 );
add_action( 'admin_color_scheme_picker', 'admin_color_scheme_picker' );

// Misc hooks.
add_action( 'admin_init', 'wp_admin_headers', 10, 0 );
add_action( 'login_init', 'wp_admin_headers', 10, 0 );
add_action( 'admin_init', 'send_frame_options_header', 10, 0 );
add_action( 'admin_head', 'wp_admin_canonical_url', 10, 0 );
add_action( 'admin_head', 'wp_site_icon', 10, 0 );
add_action( 'admin_head', 'wp_admin_viewport_meta', 10, 0 );
add_action( 'customize_controls_head', 'wp_admin_viewport_meta', 10, 0 );
add_filter( 'nav_menu_meta_box_object', '_wp_nav_menu_meta_box_object' );

// Prerendering.
if ( ! is_customize_preview() ) {
	add_filter( 'admin_print_styles', 'wp_resource_hints', 1, 0 );
}

add_action( 'admin_print_scripts', 'print_emoji_detection_script', 10, 0 );
add_action( 'admin_print_scripts', 'print_head_scripts', 20, 0 );
add_action( 'admin_print_footer_scripts', '_wp_footer_scripts', 10, 0 );
add_action( 'admin_print_styles', 'print_emoji_styles', 10, 0 );
add_action( 'admin_print_styles', 'print_admin_styles', 20, 0 );

add_action( 'admin_print_scripts-index.php', 'wp_localize_community_events', 10, 0 );
add_action( 'admin_print_scripts-post.php', 'wp_page_reload_on_back_button_js', 10, 0 );
add_action( 'admin_print_scripts-post-new.php', 'wp_page_reload_on_back_button_js', 10, 0 );
...
add_action( 'admin_notices', 'default_password_nag', 10, 0 );
add_action( 'admin_notices', 'new_user_email_admin_notice', 10, 0 );
...
add_action( 'admin_notices', 'paused_plugins_notice', 5, 0 );
add_action( 'admin_notices', 'paused_themes_notice', 5, 0 );
add_action( 'admin_notices', 'maintenance_nag', 10, 0 );
add_action( 'admin_notices', 'wp_recovery_mode_nag', 1, 0 );
